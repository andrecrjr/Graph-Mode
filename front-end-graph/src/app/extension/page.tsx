...
export default async function ExtensionPage() {
    ...
    return (
        <section className='min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900'>
            <div className='container mx-auto px-6 py-20'>
                        ...
                        <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white'>
                            ...
                            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
                                <Button size="lg" className='bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold rounded-lg'>
                                    <Link href={process.env.NEXT_PUBLIC_EXTENSION_URL || 'https://graph-mode.com/extension'} className='flex items-center gap-2'>
                                        <DownloadIcon className='w-5 h-5' />
                                        Download Extension
                                    </Link>
                                </Button>
                                <p className='text-sm text-blue-100'>
                                    Compatible with Chrome, Edge, and Chromium-based browsers and soon Firefox
                                </p>
                            </div>
                        </div>
                    </div>
